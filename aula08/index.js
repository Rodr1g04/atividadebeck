...
async function inserir(nomeTarefa) {
    const resultado = collection.insertOne({ nome: nomeTarefa, concluida: false });
    ...
    while (true) {
        ...
        switch (opcao) {
            ...
            case '3': {
                ...
                const concluidaAtual = readline.question("informa outra situação da tarefa: ");
...
switch (opcao) {
    case "1": {
        const nome = readline.question("escolha uma opcao: ");
        await inserir(nome);
        break;
    }
}